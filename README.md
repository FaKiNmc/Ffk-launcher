...
> 💡 **Want to try it out?**  
> **[Download the latest version (FKLauncher-v2.0.0)](./FKLauncher.exe)** and organize your library instantly!

### Latest Version: v2.0.0 (The Ultimate Update)
*   **Architectural Shift:** Fully migrated state management to **Zustand** for better performance and reliability.
*   **Next-Gen Scanning:** Ultra-fast scans using worker threads, incremental caching, and folder fingerprinting.
*   **Enriched Metadata:** Integrated IGDB & RAWG APIs for high-definition covers and social integration.
*   **Advanced UX:** New Mini Mode, Custom Tags, Onboarding Wizard, and automated "What's New" changelog.
*   **Stability & Logging:** Centralized logging with **electron-log**, Error Boundaries, and robust executable validation.
*   **Smart Updates:** Delta updates with silent patch installation and granular progress tracking.
...
> 💡 **¿Quieres probarlo?**  
> **[Descarga la última versión (FKLauncher-v2.0.0)](./FKLauncher.exe)** ¡y organiza tu biblioteca al instante!

### Versión Actual: v2.0.0 (The Ultimate Update)
*   **Salto Arquitectónico:** Migración completa a **Zustand** para una gestión de estado más fluida y robusta.
*   **Escaneo de Próxima Generación:** Escaneos ultra-rápidos mediante hilos de trabajo y caché inteligente.
*   **Metadatos Premium:** Integración total con IGDB y RAWG para portadas HD y presencia social.
*   **UX Evolucionada:** Nuevo Modo Mini, etiquetas, Asistente de Bienvenida y Changelog automático post-update.
*   **Estabilidad Extrema:** Logs centralizados con **electron-log**, Error Boundaries y validación de archivos.
*   **Actualizaciones Inteligentes:** Delta updates, instalación silenciosa de parches y progreso detallado.
